...
const config: Config = {
  ...
  tagline: 'Every Day is Field Day',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://docs.hamrs.app',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Discord',
              href: 'https://discord.gg/nngWMtXTqH',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/cabin-interactive/hamrs-docs',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} Cabin Interactive, LLC. Built with Docusaurus.`,
    },
    prism: {
